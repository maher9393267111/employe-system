...
const MegaMenu2 = ({
  ...
  return <Wrapper>
      ...
      <MenusContainer className="menu-list">
        <StyledCard>
          <CategoryList>
            {categories.map(item => <CategoryListItem key={item} active={openList === item ? 1 : 0} onMouseEnter={() => setOpenList(item)}>
                {item}
          ...
          width: "100%"
            ...
            <Box px={6} py={2} height="100%">
              ...
              return <Box key={key}>
                    ...
                    return <Link href="/" key={key} passHref>
                            <a>
                              <SubCategoryListItem>
                                {sub.img && <Avatar src={sub.img} sx={{
                            backgroundColor: "grey.100",
                            borderRadius: 1
                          }} />}
                                {sub.Icon && <sub.Icon sx={{
                            fontSize: 16
                          }} />}
                                {sub.title}
                              </SubCategoryListItem>
