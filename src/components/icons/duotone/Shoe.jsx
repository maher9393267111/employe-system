...
const Shoe = props => {
  return <SvgIcon viewBox="0 0 640 512" sx={{
    "& .secondary": {
      opacity: 0.4
    }
  }} {...props}>
      ...
      <path fill="currentColor" className="secondary" d="M0 415.1c0 35.37 28.62 64.01 64 64.01l32-.0103v-127.1l-32-.0005C28.62 351.1 0 380.6 0 415.1zM337.5 287.1c-35 0-76.25 13.12-104.8 31.1C208 336.4 188.3 351.1 128 351.1v128l57.5 15.98c26.25 7.25 53 13.13 80.38 15.01c32.63 2.375 65.63 .743 97.5-6.132C472.9 481.2 512 429.2 512 383.1C512 319.1 427.9 287.1 337.5 287.1z" />
    </SvgIcon>;
};
export default Shoe;