      ...
      <NavbarRoot isfixed={isFixed} sidebarstyle={sidebarStyle}>
        ...
        return <Box key={ind}>
            ...
            return <Box mb="2px" color="grey.700" key={ind}>
                    {item.child ? <Accordion>
                        <AccordionHeader px={0} py={0.75} className="linkList" sx={{
                  ":hover": {
                    color: palette.primary.main
                      ...
                      </Accordion> : <Box key={item.title} onClick={() => handleSelect(item.title)} sx={{
                color: "grey.700",
                cursor: "pointer"
              }}>
