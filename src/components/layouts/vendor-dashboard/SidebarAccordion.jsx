...
import { BadgeValue, BulletIcon, StyledText, NavItemButton, ListIconWrapper, ChevronRightIcon } from "./LayoutStyledComponents";
...
const SidebarAccordion = props => {
  ...
  return <NavExpandRoot className="subMenu">
      <NavItemButton onClick={handleClick} active={hasActive ? 1 : 0} sx={{
      justifyContent: "space-between"
        ...
        {badge && <BadgeValue compact={sidebarCompact} className="itemIcon">
            {badge.value}
          </BadgeValue>}
