...
const Section1 = ({
  ...
  return <StyledBox id="carouselBox">
      <Carousel spacing="0px" showDots={true} autoPlay={false} visibleSlides={1} showArrow={false} dotClass="carousel-dot" dotColor={palette.primary.main} totalSlides={carouselData.length}>
        {carouselData.map(({
        id,
        title,
        subTitle,
        ...
        imgUrl
            ...
            <GridItemTwo item md={6} sm={6} xs={12}>
              <LazyImage priority alt={title} width={600} height={450} src={imgUrl} layout="responsive" objectFit="contain" />
            </GridItemTwo>
          </StyledGrid>)}
      </Carousel>
    </StyledBox>;
