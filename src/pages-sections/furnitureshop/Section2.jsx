...
const Section2 = () => {
  ...
  return <Fragment>
      <Grid container spacing={3}>
        <Grid item xs={12} sm={7} md={7}>
          <Link href="/sale-page-1">
            <a>
              <LeftContentBox imgUrl={product1} sx={{
              p: "20px 30px"
            }}>
                <RightContent>
        ...
        <Grid item xs={12} sm={5} md={5}>
          <Link href="/sale-page-1">
            <a>
              <RightContentBox imgUrl={product2} sx={{
              pt: "20px"
            }}>
      ...
      {/* New Section */}
      <Grid container spacing={3} mt={0} sx={{
      [breakpoints.down("sm")]: {
        display: "flex",
        ...
        <Grid item xs={12} sm={7} md={7}>
          <Link href="/sale-page-1">
            <a>
              <RightContentBox imgUrl={product4} sx={{
              height: 484,
              pt: "20px",
              px: "80px",
        ...
        <Grid item xs={12} sm={5} md={5}>
          <Link href="/sale-page-1">
            <a>
              <LeftContentBox imgUrl={product5} sx={{
              py: "20px",
              pl: "20px"
            }}>
                <RightContent>
          ...
          <Link href="/sale-page-1">
            <a>
              <LeftContentBox imgUrl={product3} sx={{
              mt: 3,
              py: "20px",
              pl: "20px"
            }}>
